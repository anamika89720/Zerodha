        ...
        <div className='container'>
            ...
            style={{ lineHeight: "1.8", fontSize: "1.2em"}}>
             <div className='col-6 p-5'>
                ...
                and investors face in India in terms of cost, support, 
                and technology. We named the company Zerodha, a combination 
                of Zero and "Rodha", the Sanskrit word for barrier.</p>
               <p>Today, our disruptive pricing models and in-house<br/>technology 
                have made us the biggest stock broker in <br/>India.
                </p>
                <p>Over 1.6+ crore clients place billions of orders every year<br/>
                 through our powerful ecosystem of investment <br/>platforms, 
                 contributing over 15% of all Indian retail<br/> trading volumes.</p>
             </div>
             <div className='col-6 p-5'>
              ...
              goal of growing the Indian capital markets.</p>
              ...
              business and product philosophies.</p>
             </div>
            </div>
        </div>
     );

    ...
    return ( 
        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
               ...
               <div className='col-4 p-5 mt-5mb-5'>
                ...
                <div className='col-4 p-5 mt-5mb-5'>
                    ...
                    <br/>
                    <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>60 Days Challenges</a>
                    <br/>
                ...
                <div className='col-4 p-5 mt-5mb-5'>
                    <h4 className=''>Coin</h4>
                    <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>Understanding Mutual Funds</a><br/>
                    <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>About Coins</a><br/>
                    <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>Buying and selling through Funds</a><br/>
                    <a href=''style={{textDecoration:"none", lineHeight:"2.5"}}>Features on Coins</a><br/>
